...
const redirect_uri = (process.env.NODE_ENV === 'development') ? 'http://localhost:3000/' : 'https://danieladen.github.io/festival-poster-app/'; // TODO remove hard coded redirect
